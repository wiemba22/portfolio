...
const Projects = ({ title = '', img = '', description = '', techs = [] }) => {
    return (
        <div className="w-[350px] phone:w-[450px] md:w-[600px] h-fit flex flex-col items-center justify-center  gap-6 p-4 text-white bg-transparent">
            ...
            <h1 className=' font-semibold font-pops text-lg lg:text-2xl text-center w-full'>{title}</h1>
            ...
            <div className='  h-[50%]'>
                <p className=" text-[16px] md:text-base text-center font-light font-pops">{description}</p>
            </div>
            ...
            <div className='h-fit w-full underline text-center text-primary'>
